...
public class SymTable {
    public static final String DOTMANGLE = "_";
    ...
    public void pushClassScope(String id) {
        ...
        STE symEntry = lookup(id);
        //    	System.out.println("found: "+lookup(id)); //debug
    ...
    {
        //if(this.mExpType.get(exp)==null){                     //debug
        //    System.out.println("return vallue " + this.mExpType.get(exp));
        //}
        //else
        //    System.out.println("return vallue " + this.mExpType.get(exp));
